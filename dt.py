...
def server_hello(client_random):
    ...
    return server_random, selected_cipher_suite
...
def client_finished(role, key, handshake_messages):
    print(f"\n=== {role} Finished ===")
...
def simulate_tls_handshake():
    ...
    # Step 2: Server Hello
    server_random, selected_cipher_suite = server_hello(client_random)
    ...
    client_finished("Client", client_write_key, handshake_messages)
